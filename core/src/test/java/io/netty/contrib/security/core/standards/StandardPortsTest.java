...
class StandardPortsTest {
    ...
    @Test
    void from() {
        assertDoesNotThrow(() -> StandardPorts.from(1, 10));
        assertDoesNotThrow(() -> StandardPorts.from(101, 101));
        assertDoesNotThrow(() -> StandardPorts.from(5000, 5001));

        assertThrows(IllegalArgumentException.class, () -> StandardPorts.from(0, 100));
        assertThrows(IllegalArgumentException.class, () -> StandardPorts.from(101, 100));
        assertThrows(IllegalArgumentException.class, () -> StandardPorts.from(0, 65_536));
    }
